    ...
    public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,
        ...
        if (bmp != null && !bmp.isRecycled() && TextUtils.isEmpty(gifPath)) {
            ...
            if (options.shouldPostProcess()) {
                ...
                options.getDisplayer().display(bmp, imageAware, LoadedFrom.MEMORY_CACHE, BitmapDisplayer.FILE_TYPE_UNDEFINE, null);
            ...
            if (options.shouldShowImageOnLoading()) {
                ...
                if (imageAware.getDrawable() != null && imageAware.getDrawable() instanceof GifDrawable) {
                    ((GifDrawable) imageAware.getDrawable()).recycle();
                }
                imageAware.setImageDrawable(null);
            }
