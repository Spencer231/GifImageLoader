...
public interface BitmapDisplayer {
    int FILE_TYPE_UNDEFINE = 1;//未确定文件类型
    int FILE_TYPE_NORMAL_IMAGE = 2;//png或jpeg普通格式图片
    int FILE_TYPE_GIF_IMAGE = 3;//gif格式图片
    /**
     ...
     */
    void display(Bitmap bitmap, ImageAware imageAware, LoadedFrom loadedFrom, final int fileTypeStatus, final String filepath);
}
